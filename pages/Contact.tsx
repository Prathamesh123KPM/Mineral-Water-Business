...
import { Mail, Phone, MapPin, Building2, Send, Loader2, CheckCircle, AlertCircle, Globe, ChevronDown } from 'lucide-react';
...
const Contact: React.FC = () => {
  ...
  const contactFaqs = [
    {
      q: "How can I get a quotation for a mineral water plant?",
      a: "You can fill out the Technical Inquiry Form on this page with your requirements, or contact us directly via phone at +91 98210 22367 or email at krupashinduce@gmail.com. Our team typically responds with a detailed custom quotation within 24 hours."
    },
    {
      q: "What information should I provide to get an accurate plant quotation?",
      a: "Please share your desired production capacity (bottles per hour), bottle sizes, raw water source and TDS level, available land area, budget range, and target location. This helps us design the most cost-effective and efficient plant layout for your needs."
    },
    {
      q: "Do you offer free site visits and consultations?",
      a: "Yes, we offer free initial consultations for serious inquiries. For domestic projects, our engineering team can conduct on-site feasibility studies. For international projects, we begin with virtual consultations and detailed project reports before planning site visits."
    },
    {
      q: "What is the typical lead time from order to plant commissioning?",
      a: "For a standard packaged drinking water plant (2000–4000 BPH), the typical timeline is 45–90 days from order confirmation to dispatch. On-site installation and commissioning takes an additional 7–15 days depending on civil readiness and plant complexity."
    },
    {
      q: "Do you help with BIS/ISI licensing and government approvals?",
      a: "Yes, Krupashindu provides complete end-to-end guidance for obtaining BIS (IS:14543) certification, FSSAI license, pollution control board NOC, and other necessary government approvals required to legally operate a packaged drinking water plant in India."
    }
  ];
  ...
  return (
    <div className="pt-24 min-h-screen">
      <title>Contact Krupashindu | Get a Free Project Consultation</title>
      <meta name="description" content="Get in touch with Krupashindu for custom quotations, technical consultations, and expert guidance on starting your mineral water bottling plant." />

      {/* Open Graph / Facebook */}
      <meta property="og:type" content="website" />
      <meta property="og:url" content="https://mineralwaterbusiness.com/contact" />
      <meta property="og:title" content="Contact Krupashindu | Get a Free Project Consultation" />
      <meta property="og:description" content="Get in touch with Krupashindu for custom quotations, technical consultations, and expert guidance on starting your mineral water bottling plant." />
      <meta property="og:image" content="https://mineralwaterbusiness.com/Homepage.webp" />

      {/* Twitter */}
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:url" content="https://mineralwaterbusiness.com/contact" />
      <meta name="twitter:title" content="Contact Krupashindu | Get a Free Project Consultation" />
      <meta name="twitter:description" content="Get in touch with Krupashindu for custom quotations, technical consultations, and expert guidance on starting your mineral water bottling plant." />
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-teal-600 text-xs font-black uppercase tracking-[0.3em]">Contact & Inquiry</h2>
            <p className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">Frequently Asked Questions</p>
            <p className="text-slate-500 font-medium max-w-2xl mx-auto">Common questions about reaching us, getting quotes, and starting your water plant project.</p>
          </div>
          <div className="space-y-6">
