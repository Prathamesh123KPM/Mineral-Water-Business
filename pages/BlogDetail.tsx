...
const BlogDetail: React.FC = () => {
    ...
    if (!post) {
        return (
            <div className="min-h-screen pt-48 pb-24 text-center px-6">
                <title>Post Not Found | Krupashindu</title>
    ...
    const postImage = typeof post.image === 'string' && post.image.startsWith('http') 
        ? post.image 
        : `https://mineralwaterbusiness.com${post.image}`;
    ...
    const blogSchema = {
        ...
        "headline": post.title,
        "image": postImage,
        "datePublished": getISOString(post.date),
        "author": {
            "@type": "Person",
            "name": post.author || "Krupashindu Expert"
        },
        "publisher": {
            "@type": "Organization",
    ...
    return (
        <div className="min-h-screen bg-white">
            <title>{`${post.title} | Krupashindu`}</title>
            ...
            <meta property="og:url" content={`https://mineralwaterbusiness.com/blog/${post.id}`} />
            <meta property="og:title" content={`${post.title} | Krupashindu`} />
            <meta property="og:description" content={post.excerpt.length > 155 ? `${post.excerpt.substring(0, 152)}...` : post.excerpt} />
            <meta property="og:image" content={postImage} />

            {/* Twitter */}
            <meta name="twitter:card" content="summary_large_image" />
            <meta name="twitter:url" content={`https://mineralwaterbusiness.com/blog/${post.id}`} />
            <meta name="twitter:title" content={`${post.title} | Krupashindu`} />
