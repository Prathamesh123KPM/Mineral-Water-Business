    ...
    <footer className="bg-slate-900 text-gray-300 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              <img src="/waterlogo.png" alt="Krupashindu Turnkey Beverage and Mineral Water Solutions Logo" className="h-24 w-auto object-contain bg-white rounded-lg p-1" />
              <div className="flex flex-col">
                <span className="text-xl font-bold text-white">Krupashindu</span>
                <span className="text-[10px] text-gray-400 font-medium">ISO 9001:2015 Certified Engineering</span>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/KrupashinduConsultingEngineers" className="hover:text-blue-400 transition-colors"><Facebook size={20} /></a>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
          <p>© {new Date().getFullYear()} Krupashindu ISO 9001:2015 Certified Engineering Company. All rights reserved.</p>
