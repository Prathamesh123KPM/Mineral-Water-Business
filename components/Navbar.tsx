        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-3 group">
              <img src="/waterlogo.png" alt="Krupashindu Mineral Water Plant and Machinery Manufacturer Logo" className="h-20 w-auto object-contain" />
              <div className="flex flex-col">
                ...
                <span className="text-[10px] uppercase tracking-[0.2em] text-sky-500 font-bold mt-0.5">Consulting Engineers</span>
              </div>
            </Link>
          </div>
          ...
          <div className="md:hidden">
            <button
              ...
              className="text-slate-600 w-12 h-12 flex items-center justify-center hover:bg-sky-50 rounded-xl transition-colors"
        ...
        <div className={`absolute right-0 top-0 h-full w-[80%] max-w-sm bg-white shadow-2xl transition-transform duration-500 ease-out ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
          <div className="flex flex-col h-full p-8 pt-24">
            ...
            <div className="mt-auto pt-10">
              ...
              <p className="text-center text-[10px] font-bold text-slate-400 mt-6 uppercase tracking-[0.2em]">Krupashindu Consulting Engineering</p>
            </div>
          </div>
        </div>
      </div>
